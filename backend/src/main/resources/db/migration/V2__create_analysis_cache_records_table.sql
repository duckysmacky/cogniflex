...
create unique index ux_analysis_cache_records_lookup
    on analysis_cache_records (
                               input_type,
...
create index ix_analysis_cache_records_content_hash
    on analysis_cache_records (content_hash);
