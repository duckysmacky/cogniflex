    ...
    void setUp() throws IOException {
        ...
        server = InProcessServerBuilder.forName(serverName)
                ...
                .addService(new MLAnalyzerGrpc.MLAnalyzerImplBase() {
                    @Override
                    public void analyzeText(TextRequest request, StreamObserver<AnalyzeReply> responseObserver) {
                    ...
                    @Override
                    public void analyzeImage(ImageRequest request, StreamObserver<AnalyzeReply> responseObserver) {
                        responseObserver.onNext(
                                AnalyzeReply.newBuilder()
                                        .setLabel("ai")
                                        .setConfidence(0.77f)
                    ...
                    @Override
                    public void analyzeVideo(VideoRequest request, StreamObserver<AnalyzeReply> responseObserver) {
                        responseObserver.onNext(
                                AnalyzeReply.newBuilder()
                                        .setLabel("ai")
                                        .setConfidence(0.68f)
